...
## Project Structure
    ...
    ├── sensor_commissionin_35998  # Django project configurations
...
1. Clone this repo and `cd sensor_commissionin_35998`
...
2. Clone this repo and `cd sensor_commissionin_35998`
